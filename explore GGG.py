# -*- coding: utf-8 -*-
"""
Created on Wed Apr  3 20:27:30 2024
...
def cusum(time_series):
    ...
    means = time_series.groupby('final_result').mean().iloc[:,1:]
...
###End result has 22985 rows compared to student assessment of 23369 rows 
...
##Show distributions of Cu_statisitic
