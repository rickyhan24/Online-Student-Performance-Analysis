...
library(readr)
data <- read_csv("D:/MSc - Georgia Tech/Spring 2024/Data Analytics Business - MGT-6203-OAN/Project/My Part/Total.csv")
...
predictions_class <- ifelse(predictions > 0.3, 1, 0)
